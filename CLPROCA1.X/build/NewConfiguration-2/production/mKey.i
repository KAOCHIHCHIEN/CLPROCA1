...
unsigned int sod_delay_time;
unsigned int all_delay_time;
unsigned char button_push_flag;

unsigned char hotLock_push_flag;
...
void CK_Buttons_key4(void) {
    ...
    Button.bits.p0 = PORTAbits.RA1;
    Button.bits.p1 = PORTBbits.RB1;
    Button.bits.p2 = PORTBbits.RB2;
    Button.bits.p3 = PORTBbits.RB0;
    ...
    if (Button.byte == 0xFE) {
        ...
        cool_delay_time = 500;
        sod_delay_time = 500;
        hotLock_delay_time = 500;
        all_delay_time = 500;
        k2_delay_time = 500;
        other_delay_time = 500;
        k2_button_flag = 0;
        hot_button_flag = 0;
        cool_button_flag = 0;
        sod_button_flag = 0;
