...
uint16_t sh_low_delay;
uint16_t s_low_delay;
void ck_water_INIT(void) {
    sh_hi_count = 500;
    sh_low_count = 500;
    sh_low_delay = 0;
...
uint8_t ck_water2_level(void) {
    ...
    if (sh_hi_count > (500 - 50)) {
        sh_hi_flag = 1;
    } else {
        sh_hi_flag = 0;
    }
    if (sh_low_count > (500 - 50)) {
        sh_low_flag = 1;
    } else {
        sh_low_flag = 0;
    }
